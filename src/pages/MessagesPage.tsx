...
import { Check, ChevronDown, MoreVertical, Calendar, Heart, ShoppingBag, Bookmark } from "lucide-react";
    ...
    <div className={styles.main}>
      ...
      <div className={styles.buttonBlock}>
        ...
        <button className={styles.buttonReadAll} onClick={handleReadAll}>
          Прочитати всі <Check className={styles.buttonIcon} />
        </button>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className={styles.messageHeader}>
                    ...
                    >
                      ...
                      {isMenuOpen && (
                        <div className={styles.messageMenu} >
                          <button className={styles.messageMenuButton} onClick={(e) => {
                            e.stopPropagation();
                  ...
                  <small>
                    {msg.source} · {timeAgo(msg.createdAt)}
                  </small>
                </div>
              </div>
            );
